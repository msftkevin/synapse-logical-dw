...
-- A Logical data warehouse uses external data source in  CSV, Parquet, or Delta format
-- Note: Delta Update/Delete functionality is not available using SQl Serversless Pools
